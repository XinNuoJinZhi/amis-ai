# 1.2.0 多页 5 策略评测报告（20260511T192857Z）

## 策略汇总（按 strategy 聚合）

| 策略 | 任务成功率 | 平均页通过率 | 平均复用率 | 平均 LLM 调用 | 平均 LLM 耗时 | 平均总耗时 |
|---|---|---|---|---|---|---|
| **r4_baseline** | 9/9（100%）| 100% | 0.00 | 22.9 次 | 34.4s | 15.4s |
