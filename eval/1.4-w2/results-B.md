# 1.2.0 多页 5 策略评测报告（20260511T135315Z）

## 策略汇总（按 strategy 聚合）

| 策略 | 任务成功率 | 平均页通过率 | 平均复用率 | 平均 LLM 调用 | 平均 LLM 耗时 | 平均总耗时 |
|---|---|---|---|---|---|---|
| **r4_baseline** | 5/5（100%）| 100% | 0.00 | 28.8 次 | 50.1s | 22.0s |
