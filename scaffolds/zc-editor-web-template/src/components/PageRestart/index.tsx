...
import {getFormContent, getStartVarConfig} from '@/api/formRender'
...
const PageRestart = () => {
    ...
    const getFormData = async()=>{
        ...
        let res = await getFormContent(param);
    ...
    const getStartVarConfigData = async()=>{
        ...
        let res = await getStartVarConfig(param);
    ...
    const pageContent = () => {
        ...
        const amisSchema = {
            ...
            "api": {
                "method": "post",
                "url": useAdminBaseUrl("/processManage/process/start"),
                "data": {
                    "variables": {
                        "&": "$$",
                        // 'app-id': appId
